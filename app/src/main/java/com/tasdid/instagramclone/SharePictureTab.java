            ...
            case R.id.btnShareImage:
                ...
                if(receivedImageBitmap != null){
                    ...
                    if(edtDescription.getText().toString().equals("")){
                        ...
                        FancyToast.makeText(getContext(),"Error: You must specify a description", Toast.LENGTH_SHORT, FancyToast.ERROR,false).show();
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                ...
                                if(e==null){
                                    ...
                                    FancyToast.makeText(getContext(),"Upload complete", Toast.LENGTH_SHORT, FancyToast.SUCCESS,false).show();


                                }else{
                                    FancyToast.makeText(getContext(),"Unknown error:"+e.getMessage(), Toast.LENGTH_SHORT, FancyToast.ERROR,false).show();
